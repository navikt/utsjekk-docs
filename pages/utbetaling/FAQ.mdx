...
Konsumenter kan sende iverksettinger til Utsjekk når som helst og helt uavhengig av økonomisystemets åpningstider. Dette er også beskrevet under [status på utbetaling](/for_konsumenter/status#med-rest).

Se [siden om iverksetting](/for_konsumenter/utbetaling/iverksetting) for hvilke valideringer Utsjekk gjør.

Utsjekk tar også ansvar for [grensesnittavstemming](/for_konsumenter/avstemming) mot økonomisystemet.
