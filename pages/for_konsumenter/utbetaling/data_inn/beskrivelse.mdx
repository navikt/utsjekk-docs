...
|:--------------------|:--------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| sakId               | ➡️💰⚙️  | Id på saken i vedtaksløsningen. Maks 30 tegn.                                                                                                                                                                                                |
...
| iverksettingId      | 💰      | Id på iverksettingen. Brukes kun når vedtaksløsningen må iverksette flere ganger for samme behandling/vedtak. Brukes kun internt i Utsjekk.                                                                                                  |
...
| forrigeIverksetting | 💰⚙️    | Identifikasjon på forrige iverksetting. Settes kun når det finnes tidligere iverksettinger på saken. Brukes internt i Utsjekk for å beregne korrekt utbetaling.                                                                              |
...
| fraOgMedDato | ➡️💰⚙️  | fraOgMedDato for utbetalingsperioden. For månedssats må denne alltid være første dag i måneden.                                                                                                                                            |
| tilOgMedDato | ➡️💰⚙️  | tilOgMedDato for utbetalingsperioden. For månedssats må denne alltid være siste dag i måneden.                                                                                                                                             |
